...
conversationDefinition = [
  ...
  {meta: "vaarwel", exclusive: false, askMore: false, matching: [
      ...
      {
        message: "Ik wens u een fijne dag verder en veel success.",
        type: "text",
      }
    ]},
  ...
  {meta: "overmaken", exclusive: true, askMore: true, matching: [
  ...
  {meta: "hoelang1", exclusive: true, askMore: true, matching: [
  ...
  {meta: "hoelang2", exclusive: true, askMore: false, matching: [
      "1 of 0,5 maand",
      "Heb ik dan recht op 1 of 0,5 maand uitkering per jaar?",
    ], response: [
      {
  ...
  {meta: "hoelang3", exclusive: true, askMore: false, matching: [
      ...
      {
        message: "Voor ieder volledig kalenderjaar heeft u recht op 1 maand WW-uitkering.",
        type: "text",
      }
    ]},

  {meta: "hoelang4", exclusive: true, askMore: false, matching: [
  ...
  {meta: "nodig", exclusive: true, askMore: true, matching: [
      ...
      {
        message: "Hier heeft u een DigiD voor nodig.",
        type: "text",
      },
      {
  ...
  {meta: "eerstebetaling", exclusive: true, askMore: true, matching: [
