...
conversationGreeting = [
  ...
  {
    message: "Ik zal u proberen te helpen wanneer onze medewerkers niet beschikbaar zijn.",
    type: "text",
    meta: ["groet"],
  }
];
...
conversationDefinition = [
  ...
  {meta: "help", exclusive: true, askMore: false, matching: [
      "hulp",
      "help",
      "vraag",
      "vragen",
  ...
  {meta: "voorwaarden", exclusive: true, askMore: true, matching: [
      ...
      "Wat zijn mijn plichten voordat ik WW aanvraag?",
    ], response: [
      {
        message: "U mag een WW-uitkering aanvragen als u:" +
                 "<ul>" +
  ...
  {meta: "weerwerken", exclusive: true, askMore: true, matching: [
      ...
      "Kan ik werken tijdens mijn WW-uitkering?",
    ], response: [
      {
        message: "De eerste 2 maanden dat u weer werkt trekken wij 75% van uw inkomsten uit werk af van uw WW-maandloon. Vanaf de derde maand is dat 70%.",
        type: "text",
      },
      {
        message: "Uw uitkering stopt als uw inkomsten uit werk meer dan 87,5% van uw uitkering zijn.",
        type: "text",
      }
    ]},

  {meta: "statusvolgen", exclusive: true, askMore: true, matching: [
      "Hoe volg ik de status van mijn aanvraag?",
      "Hoe weet ik wat de beslissing is over mijn aanvraag?",
    ], response: [
      {
        message: "U kunt de status van uw aanvraag volgen via <a class=\"btn-close\" target=\"uwvFrame\" href=\"https://werknemer-portaal.uwv.nl/mijnuwv/PersoonlijkeGegevens\">Mijn UWV<a>.",
        type: "text",
      }
    ]},
  ...
  {meta: "dagloon", exclusive: true, askMore: true, matching: [
      ...
      "Hoeveel WW-uitkering kan ik verwachten te krijgen?",
      "Hoeveel WW-uitkering krijg ik?",
      "Hoeveel WW-uitkering?",
  ...
  {meta: "hoelang3", exclusive: true, askMore: false, matching: [
      ...
      {
        message: "Voor ieder jaar aan arbeidsverleden voor 2016 heeft u recht op 1 maand WW-uitkering.",
        type: "text",
      },
      {
        message: "Voor ieder jaar aan arbeidsverleden vanaf 2016 heeft u recht op 0,5 maand WW-uitkering.",
        type: "text",
      }
    ]},
